...
def train(num_epoch):
    ...
    if num_epoch > learning_rate_decay_start >= 0:
        frac = (num_epoch - learning_rate_decay_start) // learning_rate_decay_every
...
def PublicTest(num_epoch):
    ...
    if PublicTest_acc > best_PublicTest_acc:
        ...
        best_PublicTest_acc_epoch = num_epoch


def PrivateTest(num_epoch):
    ...
    if PrivateTest_acc > best_PrivateTest_acc:
        ...
        state = {
            ...
            'best_PrivateTest_acc_epoch': num_epoch,
        }
        if not os.path.isdir(path):
            os.mkdir(path)
